        ...
        <div className="contact-grid">
          ...
          <div className="contact-info-panel">
            ...
            <div className="contact-links">
              ...
              <a href="https://www.linkedin.com/in/sri-sai-rahul-7b08b51b1/" target="_blank" rel="noopener noreferrer" className="contact-link-card">
                <div className="clc-icon">
                ...
                <div className="clc-text">
                  ...
                  <span>linkedin.com/in/sri-sai-rahul-7b08b51b1</span>
                </div>
                <span className="clc-arrow">→</span>
              </a>
            </div>
